...
function Movies() {
  return (
    <div className="p-8 text-center">
      <h1 className="text-3xl font-bold text-slate-800">🏠 หน้าMovie</h1>
...
const GENERS = [...new Set(movies.map(m => m.genre))];
...
function Movies() {
  ...
  return (
    <div className="mx-auto max-w-5xl p-8">
      ...
      <GenreBox genre={genre} onGenreChange={setGenre} genres = {GENERS} />
